...
class PostDataToRestApi {
  init (resourceConfig, env) {
    ...
    this.webAPITimeoutInMilliseconds = (process.env.WEB_API_TIMEOUT_IN_MS || 5000)
  }
  ...
  async run (event, context) {
    ...
    const options = {
      headers: {},
      method: 'post',
      timeout: this.webAPITimeoutInMilliseconds, // configure a response timeout
      signal: AbortSignal.timeout(this.webAPITimeoutInMilliseconds), // configure a connection timeout (https://axios-http.com/docs/cancellation)
